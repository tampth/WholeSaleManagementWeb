...
namespace WholeSaleManagementApp.Migrations
{
    ...
    [Migration("20220113142249_AddThumb")]
    partial class AddThumb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.DealStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.QuoteLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.QuoteStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.AppUser", b =>
                {
                    b.HasOne("WholeSaleManagementApp.Models.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.Deal", b =>
                {
                    b.HasOne("WholeSaleManagementApp.Models.Contact", "Contact")
                        .WithMany("Deals")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WholeSaleManagementApp.Models.DealStatus", "DealStatus")
                        .WithMany("Deals")
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.Quotation", b =>
                {
                    ...
                    b.HasOne("WholeSaleManagementApp.Models.QuoteStatus", "QuoteStatus")
                        .WithMany("Quotations")
            ...
            modelBuilder.Entity("WholeSaleManagementApp.Models.QuoteLine", b =>
                {
                    ...
                    b.HasOne("WholeSaleManagementApp.Models.Quotation", "Quotation")
                        .WithMany("QuoteLines")
