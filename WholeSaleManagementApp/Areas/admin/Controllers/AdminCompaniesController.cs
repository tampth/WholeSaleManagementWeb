...
namespace WholeSaleManagementApp.Areas.admin.Controllers
{
    ...
    public class AdminCompaniesController : Controller
    {
        ...
        public AdminCompaniesController(MyDbContext context)
        {
            _context = context;
        }

        // GET: admin/AdminCompanies
        public async Task<IActionResult> Index()
        {
            return View(await _context.Companies.ToListAsync());
        }

        // GET: admin/AdminCompanies/Details/5
        ...
        // GET: admin/AdminCompanies/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: admin/AdminCompanies/Create
        ...
        // GET: admin/AdminCompanies/Edit/5
        ...
        // POST: admin/AdminCompanies/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: admin/AdminCompanies/Delete/5
        ...
        // POST: admin/AdminCompanies/Delete/5
